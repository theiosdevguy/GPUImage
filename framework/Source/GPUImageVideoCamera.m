...
@property (nonatomic, weak) id<AVCaptureVideoDataOutputSampleBufferDelegate> sDelegate;
...
- (void)deviceDidRotate:(NSNotification *)notification {
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        //        AVCaptureConnection *con = [self.stillImageOutput connectionWithMediaType:AVMediaTypeVideo];
...
{
    if (_sDelegate) {
        [_sDelegate captureOutput:captureOutput didOutputSampleBuffer:sampleBuffer fromConnection:connection];
    }
